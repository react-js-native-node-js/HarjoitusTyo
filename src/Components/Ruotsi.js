...
class Ruotsin extends Component {
  ...
  componentDidMount = () => {
    return (                 //Jos halaut hakea maiden kaupunkien säätiedit - poista kohta "lang=fi&lat=60.17&lon=24.94&units=metric" ja lisää siihen q=(kaupungin nimen)
       fetch('http://api.openweathermap.org/data/2.5/weather?q=Stockholm&APPID=0ef041b3f39095189c251ead26cc1b0d')
